(function (global, factory) {
	...
	*/
	...
	jQuery(document).ready(function ($) {
	  ...
	  if ($('body').hasClass('page-template-small-business-loans-alt') || $('body').hasClass('page-template-loans-temporary') || $('body').hasClass('page-template-loans-contractors') || $('body').hasClass('page-template-loans-cleaning') || $('body').hasClass('page-template-loans-retail') || $('body').hasClass('page-template-policy-security')) {
	    // Slick slider init
	    var options = {
	      slidesToShow: 3,
	      slidesToScroll: 3,
	      ...
	      customPaging: function (slick, index) {
	        return '<button type="button" data-slick-index="' + index + '">' + '<span class="visually-hidden">Slide ' + (index + 1) + '</span></button>';
	      },
	      arrows: false,
	      infinite: false,
	      responsive: [{
	  ...
	  if ($('body').hasClass('page-template-business-line-of-credit') || $('body').hasClass('page-template-business-term-loan') || $('body').hasClass('page-template-campaign-direct')) {
	    // Slick slider init
	    var options = {
	      slidesToShow: 1,
	      slidesToScroll: 1,
	      ...
	      nextArrow: '<button type="button" class="slick-arrow slick-next btn btn-outline-light">' + '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 15.5" class="arrow"><path d="M7.7 8.5c.4-.4.4-1.1 0-1.6L1.5.3C1.3.1 1.1 0 .9 0 .4 0 0 .3 0 .8c0 .2.1.5.2.6l5.9 6.3L.2 14c-.3.3-.3.9 0 1.2.2.1.4.2.6.2.2 0 .4-.1.6-.3.1.1 6.3-6.6 6.3-6.6z"/></svg>' + '<span class="visually-hidden">Next Slide</span>' + '</button>',
	      prevArrow: '<button type="button" class="slick-arrow slick-prev btn btn-outline-light">' + '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 15.5" class="arrow"><path d="M.3 6.9c-.4.4-.4 1.1 0 1.6l6.2 6.6c.2.2.4.3.6.3.5 0 .9-.3.9-.8 0-.2-.1-.5-.2-.6L1.9 7.7l5.9-6.3c.3-.3.3-.9 0-1.2-.2-.1-.4-.2-.6-.2-.2 0-.4.1-.6.3C6.5.2.3 6.9.3 6.9z"/></svg>' + '<span class="visually-hidden">Previous Slide</span>' + '</button>',
	      arrows: true,
	      infinite: false,
	      responsive: [{
	        breakpoint: 992,
	  ...
	  if ($('body').hasClass('page-template-news')) {
	    ...
	    pr_load_all_posts(1); // Pagination
